    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="masthead-brand">Recommender System - Simulation Stage 2</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading">Tahap 2</h1>
                <p>
                ...
                <a class="btn btn-lg btn-default" href="<%=Config.SITE_URL%>/survey/testTime/methodA/part2">Lanjutkan</a>
            </div>
            <div class="mastfoot">
                <div class="inner">
