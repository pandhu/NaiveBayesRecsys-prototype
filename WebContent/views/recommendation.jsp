    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner cover">
                <h1 class="cover-heading">Recommendation Section</h1>
                <p>
                    Anda telah menyelesaikan beberapa transaksi, berikut detail transaksi:
                </p>
                <ol>
                    <%for(Item item : ((User)request.getSession().getAttribute("user")).itemTransactions){%>
                        <li><%=item.name%></li>
                    <%}%>
                </ol>
                <a class="btn btn-lg btn-default" href="<%=Config.SITE_URL%>/recommendation/topN?stage=1">Lanjutkan</a>
            </div>
            <div class="mastfoot">
                <div class="inner">
